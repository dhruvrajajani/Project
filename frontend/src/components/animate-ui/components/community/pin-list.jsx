...
function PinList({
  ...
  const [togglingGroup, setTogglingGroup] = React.useState(null);
            ...
            <div
              ...
              {pinned.map((item) => (
                <motion.div
                  ...
                  <div
                    className="flex items-center justify-center size-8 rounded-full bg-neutral-400 dark:bg-neutral-600">
            ...
            <div
              ...
              {unpinned.map((item) => (
                <motion.div
                  ...
                  <div
                    className="flex items-center justify-center size-8 rounded-full bg-neutral-400 dark:bg-neutral-600 opacity-0 group-hover:opacity-100 transition-opacity duration-250">
